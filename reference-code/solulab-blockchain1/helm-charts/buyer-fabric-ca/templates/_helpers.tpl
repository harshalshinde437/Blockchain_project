...
- name: FABRIC_CA_SERVER_CSR_HOSTS
  value: "{{ include "fabric-ca.fullname" . }}, {{ include "fabric-ca.fullname" . }}.{{ .Values.tls_domain }}, {{ include "fabric-ca.fullname" . }}.{{ .Values.other_csr_names.namespace }}.svc, localhost"
